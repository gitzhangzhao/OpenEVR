...
COPY revolution_gtx_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\revolution_gtx_top.ucf -p xc6vlx75t-ff784-1 revolution_gtx_top.ngc revolution_gtx_top.ngd
...
ECHO 'Running NGD'
map -p xc6vlx75t-ff784-1 -o mapped.ncd revolution_gtx_top.ngd
...
netgen -ofmt verilog -sim -sdf_path ../../implement/results -dir . -tm revolution_gtx_top -w routed.ncd routed.v
