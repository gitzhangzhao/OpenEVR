...
COPY revolution_gtx_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\revolution_gtx_top.ucf -p xc6vlx75t-ff784-1 revolution_gtx_top.edf revolution_gtx_top.ngd
